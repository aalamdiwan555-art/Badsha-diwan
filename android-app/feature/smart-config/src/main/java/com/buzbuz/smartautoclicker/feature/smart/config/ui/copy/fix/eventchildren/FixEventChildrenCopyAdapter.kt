...
private object FixEventChildrenDiffUtilCallback : DiffUtil.ItemCallback<FixCopyUiItem>() {
    override fun areItemsTheSame(oldItem: FixCopyUiItem, newItem: FixCopyUiItem): Boolean =
        when {
            oldItem is FixCopyUiItem.Header && newItem is FixCopyUiItem.Header -> true
            oldItem is FixCopyUiItem.Item.EventChildren.ActionItem && newItem is FixCopyUiItem.Item.EventChildren.ActionItem ->
                oldItem.uiAction.action.id == newItem.uiAction.action.id
            oldItem is FixCopyUiItem.Item.EventChildren.ConditionItem && newItem is FixCopyUiItem.Item.EventChildren.ConditionItem ->
