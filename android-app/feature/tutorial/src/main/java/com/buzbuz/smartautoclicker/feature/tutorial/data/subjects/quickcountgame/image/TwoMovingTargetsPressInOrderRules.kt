...
internal class TwoMovingTargetsPressInOrderRules : QuickClickGameRules {
    ...
    override fun onTargetHit(
        ...
        when {
            type == QuickClickGameTargetType.IMAGE_RED && current.containsKey(QuickClickGameTargetType.IMAGE_RED) && current.containsKey(QuickClickGameTargetType.IMAGE_BLUE) ->
                removeRedTarget(current)

            type == QuickClickGameTargetType.IMAGE_BLUE && !current.containsKey(QuickClickGameTargetType.IMAGE_RED) && current.containsKey(QuickClickGameTargetType.IMAGE_BLUE) -> {
                score += 2
                getNewTargets()
            }
