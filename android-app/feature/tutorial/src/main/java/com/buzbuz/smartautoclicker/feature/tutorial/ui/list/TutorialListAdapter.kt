...
object TutorialCategoryUiItemsDiffUtilCallback : DiffUtil.ItemCallback<TutorialCategoryUiItems>() {
    ...
    override fun areItemsTheSame(oldItem: TutorialCategoryUiItems, newItem: TutorialCategoryUiItems): Boolean =
        when {
            oldItem is TutorialCategoryUiItems.Header && newItem is TutorialCategoryUiItems.Header -> true
            oldItem is TutorialCategoryUiItems.Item.Category && newItem is TutorialCategoryUiItems.Item.Category ->
                oldItem.type == newItem.type

            oldItem is TutorialCategoryUiItems.Item.Tutorial && newItem is TutorialCategoryUiItems.Item.Tutorial ->
                oldItem.type == newItem.type
